...
, 1);
    ...
    var t, s, i;
    for(i=0;
    i<this.settings.slides.length;
    i++)(this.settings.preload||this.settings.preloadImages)&&this.settings.slides[i].src&&(s=new Image, s.src=this.settings.slides[i].src), (this.settings.preload||this.settings.preloadVideos)&&this.support.video&&this.settings.slides[i].video&&(t=this._video(this.settings.slides[i].video instanceof Array?this.settings.slides[i].video: this.settings.slides[i].video.src));
}
, _random:function(t) {
...
, shuffle:function() {
    for(var t, s, i=this.total-1;
    i>0;
    i--)s=Math.floor(Math.random()*(i+1)), t=this.settings.slides[i], this.settings.slides[i]=this.settings.slides[s], this.settings.slides[s]=t;
}
, play: function() {
...
, options:function(i, e) {
    ...
    if("object"==typeof i)this.settings=t.extend( {
}
, s, t.vegas.defaults, i);
    else {
